"""Call me bot platform for notify component."""
...
BASE_API_URL = "https://api.callmebot.com"
TIMEOUT = 5
...
def get_service(
    ...
    """Get the Call me bot notification service."""
    if not _authenticate(config):
        _LOGGER.error("You are not authorized to access Callmebot")
        return None
